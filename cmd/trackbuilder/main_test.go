...
func TestRunWritesCatalogJSONToStdoutAndReportToStderr(t *testing.T) {
	...
	for _, want := range []string{"layoutId:", "source point count:", "source segment count:", "source segment length meters:", "source heading change:", "source path length meters:", "generated point count:", "generated path length meters:", "catalogLengthMeters:", "deltaMeters:", "deltaPct:"} {
