...
func TestRunWritesCatalogJSONToStdoutAndReportToStderr(t *testing.T) {
	...
	for _, want := range []string{"layoutId:", "source point count:", "source segment count:", "source segment length meters:", "source planar heading change (X/Z):", "source local chord excess (4-point windows):", "source path length meters:", "generated point count:", "generated path length meters:", "catalogLengthMeters:", "deltaMeters:", "deltaPct:"} {
