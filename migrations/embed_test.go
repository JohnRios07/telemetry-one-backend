...
func TestUpFilesIncludesRuntimePersistenceMigrationInOrder(t *testing.T) {
	...
	want := []string{"000001_initial_persistence.up.sql", "000002_sessions_lifecycle.up.sql", "000003_runtime_persistence.up.sql", "000004_detected_track_layout.up.sql", "000005_ingest_rejection_summaries.up.sql", "000006_persist_laps.up.sql", "000007_persist_lap_samples.up.sql", "000008_lap_telemetry_gap_count.up.sql", "000009_manual_layout_selection.up.sql"}
