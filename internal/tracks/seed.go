...
func OfficialGT7SeedCatalog() Catalog {
	...
	return Catalog{
		...
		Tracks: []CatalogTrack{
			...
			track("gt7_brands_hatch", "Brands Hatch", "United Kingdom", []Source{officialTracklist, gt7Info},
				layoutFromGT7Info(346, "Brands Hatch Indy Circuit", 1944, 0, []Source{officialTracklist, gt7Info}),
			),
